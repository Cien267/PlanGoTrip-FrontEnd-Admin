...
import {
  URL_GET_RESTAURANT_CATEGORIES,
  URL_DELETE_RESTAURANT_CATEGORY,
} from '@/constants/url'
import InputText from 'primevue/inputtext'
import Column from 'primevue/column'
import DataTable from 'primevue/datatable'
import Button from 'primevue/button'
import type { DestinationRestaurantCategoryType } from '@/types'
...
// list categories
const categories = ref<DestinationRestaurantCategoryType[]>()
...
const removeCategory = (
  event: any,
  category: DestinationRestaurantCategoryType,
) => {
  confirm.require({
    ...
    accept: async () => {
      await fetchData(
        `${URL_DELETE_RESTAURANT_CATEGORY}/${category.id}`,
        'DELETE',
      )
      if (error.value) {
        toast.add({
