...
import {
  URL_GET_ATTRACTION_CATEGORIES,
  URL_DELETE_ATTRACTION_CATEGORY,
} from '@/constants/url'
import InputText from 'primevue/inputtext'
import Column from 'primevue/column'
import DataTable from 'primevue/datatable'
import Button from 'primevue/button'
import type { DestinationAttractionCategoryType } from '@/types'
...
// list categories
const categories = ref<DestinationAttractionCategoryType[]>()
...
const removeCategory = (
  event: any,
  category: DestinationAttractionCategoryType,
) => {
  confirm.require({
    ...
    accept: async () => {
      await fetchData(
        `${URL_DELETE_ATTRACTION_CATEGORY}/${category.id}`,
        'DELETE',
      )
      if (error.value) {
        toast.add({
